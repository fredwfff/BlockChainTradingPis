...
This module manages the wallet functionality for the Bollinger trading node. It tracks the node's balance and assets, ensuring all updates are thread-safe.
